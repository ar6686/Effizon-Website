...
<div className="role">
    ...
    <div className="responsiveWork">
        ...
        <h1>Key Features</h1>
        <p>Ensuring optimal viewing on all devices, from desktops to smartphones. Integrated to simplify appointment scheduling for patients. Enhanced to improve search engine rankings and visibility. Easy-to-update platform for the clinic staff.  Immediate assistance for inquiries and appointment setups.</p>
        </div>
    ...
    <div className="allStuff">
        <div className="allStuffText">
            ...
            <p>Explore the key features and design elements implemented for the Panorama Dental Clinic website. Below are visual representations of the site layout, functionality, and aesthetics.</p>
        </div>
