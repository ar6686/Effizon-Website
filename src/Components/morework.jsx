...
const works = [
    {
        title: 'CHEVO',
        name: 'Built a multilingual and responsive website for his virtual assistant.',
...
function MoreWork() {
    ...
    return (
        <section className="morework-section">
            {works.map((item, i) => (
                <article
                    key={i}
                    style={{
